  ...
  build: {
    rollupOptions: {
      input: {
        ...
        economy: path.resolve(__dirname, 'economy.html'),
        elite: path.resolve(__dirname, 'elite.html'),
        luxe: path.resolve(__dirname, 'luxe.html'),
        industrial: path.resolve(__dirname, 'industrial.html'),
